...
###  4.0 CONCLUSION
1. 50% of Users are not getting up to 7 hours (420 minutes) of sleep. This represent an opportunity for Bellabeat as Bellabeat's Time product can be used to improve Users sleep hours with the use of notifications and targets.
3. 54% of the Users are taking less steps than the average. This also represnt an opportunity for Bellabeat Tracker product which can be used to improve users steps by setting targets for the users to achieve everyday.
5. 42% of Users are performing badly with less steps, active minutes and sleep than the average. This is an opportunity for Bellabeat's lifestyle product which can be used to rate users on how they are fairing in different metrics and set target for each of the metrics that users can meet to ensure a healthy lifestyle. Bellabeat's Memership subscription services can have a big impact here as this represent a big market that it can tap into, giving Users addtional coaching and management of Users health and lifestyle.
